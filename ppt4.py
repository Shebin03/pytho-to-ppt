...
table.cell(0, 0).text = data2["Name and Designation"]
...
for i in data2['Key Projects']:
    for j in i:
        table.cell(2, 1).text+= i[j]



#table.cell(5, 0).text
for i in data2['Area of expertise']:
    for j in i:
        table.cell(6, 0).text+= i[j]
